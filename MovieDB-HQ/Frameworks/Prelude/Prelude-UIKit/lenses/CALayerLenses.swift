...
extension LensHolder where Object: CALayerProtocol {
  ...
  public var backgroundColor: Lens<Object, CGColor?> {
    return Lens(
  ...
  public var bounds: Lens<Object, CGRect> {
    return Lens(
      view: { $0.bounds },
      set: { $1.bounds = $0; return $1 }
    )
  }
  ...
  public var position: Lens<Object, CGPoint> {
    return Lens(
      view: { $0.position },
      set: { $1.position = $0; return $1 }
    )
  }
}
