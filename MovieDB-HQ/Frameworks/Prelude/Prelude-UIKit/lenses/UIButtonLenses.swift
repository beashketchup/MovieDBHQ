...
public extension LensHolder where Object: UIButtonProtocol {
  ...
  func attributedTitle(for state: UIControlState) -> Lens<Object, NSAttributedString> {
    return Lens(
  ...
  func backgroundColor(for state: UIControlState) -> Lens<Object, UIColor> {
    return Lens(
      view: { _ in .clear },
  ...
  func image(for state: UIControlState) -> Lens<Object, UIImage?> {
    return Lens(
  ...
  func titleColor(for state: UIControlState) -> Lens<Object, UIColor> {
    return Lens(
  ...
  func title(for state: UIControlState) -> Lens<Object, String?> {
    return Lens(
...
extension Lens where Whole: UIButtonProtocol, Part == UIImageView {
  public var contentMode: Lens<Whole, UIViewContentMode> {
    return Whole.lens.imageView..Part.lens.contentMode
  }
}
