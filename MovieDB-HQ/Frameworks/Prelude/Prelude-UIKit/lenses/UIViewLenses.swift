...
public extension LensHolder where Object: UIViewProtocol {
  ...
  func contentCompressionResistancePriority(for axis: UILayoutConstraintAxis)
  ...
  func contentHuggingPriority(for axis: UILayoutConstraintAxis)
    -> Lens<Object, UILayoutPriority> {
...
public protocol UIVisualEffectViewProtocol: KSObjectProtocol, LensObject {
  var effect: UIVisualEffect? { get set }
}

extension UIVisualEffectView: UIVisualEffectViewProtocol {}

public extension LensHolder where Object: UIVisualEffectViewProtocol {
  var effect: Lens<Object, UIVisualEffect?> {
    return Lens(
      view: { $0.effect },
      set: { $1.effect = $0; return $1 }
    )
  }
}
