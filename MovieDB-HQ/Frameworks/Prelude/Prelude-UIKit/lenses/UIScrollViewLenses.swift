...
public extension LensHolder where Object: UIScrollViewProtocol {
  ...
  var decelerationRate: Lens<Object, CGFloat> {
    return Lens(
  ...
  var keyboardDismissMode: Lens<Object, UIScrollViewKeyboardDismissMode> {
    return Lens(
  ...
  var isPagingEnabled: Lens<Object, Bool> {
    return Lens(
      view: { $0.isPagingEnabled },
      set: { $1.isPagingEnabled = $0; return $1 }
    )
  }
}
